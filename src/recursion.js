...
var sum = function(array) {
  ...
  sumOfArr += array[0] + sum(array.slice(1));
  return sumOfArr;
};
...
var reverse = function(string) {
  ...
  var newStr = string.slice(string.length-1)
  revStr += string.slice(string.length-1) + reverse(string.slice(0, string.length-1));
  return revStr;
};
